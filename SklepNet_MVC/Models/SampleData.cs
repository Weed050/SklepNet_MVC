...
namespace SklepNet_MVC.Models
{
    public class SampleData
    {
        ...
        {
            using (var context = new SklepNetDBContext(
                serviceProvider.GetRequiredService<DbContextOptions<SklepNetDBContext>>()))
            {
                ...
                //    new Product { Name = "Product 2", Price = 20.49 },
                ...
                //protected void Seed(SklepNetDBContext context)
                //{
                ...
                if (!context.Towar.Any())
                {
                    ...
                    {
                       new Towar { Nazwa = "Towar 1", Opis = "Opis towaru 1",
                           VIPtowar = false, towarPromocyjny = true, Cena = 1 },
                       new Towar { Nazwa = "Towar 2", Opis = "Opis towaru 2",
                           VIPtowar = false, towarPromocyjny = true, Cena = 2 },
                       new Towar { Nazwa = "Towar 3", Opis = "Opis towaru 3",
                           VIPtowar = false, towarPromocyjny = true, Cena = 3 },
                       new Towar { Nazwa = "Towar 4", Opis = "Opis towaru 4",
                           VIPtowar = false, towarPromocyjny = true, Cena = 4 },
                       new Towar { Nazwa = "Towar 5", Opis = "Opis towaru 5",
                           VIPtowar = false, towarPromocyjny = true, Cena = 5 },
                       new Towar { Nazwa = "Towar 6", Opis = "Opis towaru 6",
                           VIPtowar = false, towarPromocyjny = true, Cena = 6 },
                       new Towar { Nazwa = "Towar 7", Opis = "Opis towaru 7",
                           VIPtowar = false, towarPromocyjny = true, Cena = 7 },
                       new Towar { Nazwa = "Towar 8", Opis = "Opis towaru 8",
                           VIPtowar = false, towarPromocyjny = true, Cena = 8 },
                       new Towar { Nazwa = "Towar 9", Opis = "Opis towaru 9",
                           VIPtowar = false, towarPromocyjny = true, Cena = 9 },
                       new Towar { Nazwa = "Towar 10", Opis = "Opis towaru 10",
                           VIPtowar = false, towarPromocyjny = true, Cena = 10 }
                    };
