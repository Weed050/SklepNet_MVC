...
builder.Services.AddDbContext<SklepNetDBContext>(o => o.UseSqlServer(builder.Configuration.GetConnectionString("SklepNetMVCConnectionString")));
...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        // Tutaj mo¿esz dodaæ kod inicjalizacji bazy danych, jeœli to konieczne.
